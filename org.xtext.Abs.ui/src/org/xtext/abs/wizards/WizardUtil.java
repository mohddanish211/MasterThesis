...
import org.xtext.abs.UtilityFunctions.EditorPosition;
...
public class WizardUtil {
	 ...
	 * @param insertOffset
	 */
	protected static void saveEditorAndGotoOffset(ITextEditor editor, int insertOffset) {
	 ...
	 */
	protected static ITextEditor getEditorForModuleDecl(InternalASTNode<ModuleDecl> m) {
		if (m != null) {
