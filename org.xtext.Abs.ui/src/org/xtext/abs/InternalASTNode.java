...
public class InternalASTNode<T extends ASTNode<?>> {
	...
	private final SampleABSNature nature;
	private final T node;
	
	public InternalASTNode(T node, SampleABSNature nature){
		this.node = node;
	 ...
	 */
	public static <T extends ASTNode<?>> List<InternalASTNode<T>> wrapASTNodes(T[] list, SampleABSNature nature) throws IllegalArgumentException{
