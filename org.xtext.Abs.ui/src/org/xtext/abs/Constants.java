...
public class Constants {
	 ...
	 */
	public final static String ICON_PATH = "resources/icons/";
	...
	//-------------------- IDENTIFIER -------------------------------------------------------------------------
	public static final String PLUGIN_PACKAGE               = "org.xtext.Abs.ui";
	 ...
	 */
	public static final String NATURE_ID               = PLUGIN_PACKAGE + ".sampleABSNature";
	public static final String ABSDEBUGVIEW_CONTEXT_ID = PLUGIN_PACKAGE + ".debugViewContext";
	public static final String BUILDER_ID              = PLUGIN_PACKAGE + ".sampleABSBuilder";
	public static final String ACTION_EXEC_ID          = PLUGIN_PACKAGE + ".execMaude";
	public static final String EDITOR_ID               = "org.xtext.Abs";
