...
public class ABSChildActivator extends AbsActivator{
	...
	// The shared instance
	private static ABSChildActivator plugin;

	/**
	 * The constructor
	 */
	public ABSChildActivator() {
		super();
		plugin = this;
	}
	...
	public static void initializeColors(){
		...
		colorRegistry.put(Constants.STYLER_COLOR_BLACK, Constants.STYLER_COLOR_BLACK_RGB);
		colorRegistry.put(Constants.STYLER_COLOR_GREY, Constants.STYLER_COLOR_GREY_RGB);
		colorRegistry.put(Constants.STYLER_COLOR_TYPES, Constants.STYLER_COLOR_TYPES_RGB);
	}
	 ...
	 */
	public static ABSChildActivator getDefault() {
		return plugin;
	}
