...
import static org.xtext.abs.UtilityFunctions.hasDecls;
import static org.xtext.abs.navigator.NavigatorUtils.buildRegex;
...
public class ModulePath {
	 ...
	 */
	final private SampleABSNature absNature;
	/**
	 ...
	 */
	private static Map<SampleABSNature,ModulePath> rootPath = new HashMap<SampleABSNature,ModulePath>();
	 ...
	 */
	public ModulePath(SampleABSNature nature, String initialModulePath){
		if (nature == null) {
	 ...
	 */
	public SampleABSNature getNature() {
		return absNature;
	}
	 ...
	 */
	public static List<Object> getRootHierarchy(SampleABSNature nature){
		ModulePath root;
	...
	public static void clearRootHierarchyCache() {
		rootPath = new HashMap<SampleABSNature, ModulePath>();
	}
