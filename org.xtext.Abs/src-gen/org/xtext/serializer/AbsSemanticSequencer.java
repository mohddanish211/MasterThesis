...
public class AbsSemanticSequencer extends AbstractDelegatingSemanticSequencer {
		...
		if (epackage == AbsPackage.eINSTANCE)
			...
			case AbsPackage.APPLICATION_CONDITION:
				if (rule == grammarAccess.getApplication_conditionRule()
					...
					sequence_AppCond_atomic_expr_AppPrimary_exp(context, (Application_condition) semanticObject); 
					return; 
				}
	 ...
	 *
	 * Constraint:
	 *     (delta_id+=[Delta_decl|TYPE_IDENTIFIER] delta_id+=[Delta_decl|TYPE_IDENTIFIER]*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (left=AppAnd_exp_AppAnd_exp_1_0 right=AppPrimary_exp)
	 */
	protected void sequence_AppAnd_exp(ISerializationContext context, AppAnd_exp semanticObject) {
		...
		feeder.accept(grammarAccess.getAppAnd_expAccess().getRightAppPrimary_expParserRuleCall_1_2_0(), semanticObject.getRight());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (app_cond=AppPrimary_exp | feature=[Feature|TYPE_IDENTIFIER])
	 */
	protected void sequence_AppCond_atomic_expr_AppPrimary_exp(ISerializationContext context, Application_condition semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_AppCond_atomic_expr(ISerializationContext context, Application_condition semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getAppCond_atomic_exprAccess().getFeatureFeatureTYPE_IDENTIFIERTerminalRuleCall_0_1(), semanticObject.eGet(AbsPackage.Literals.APPLICATION_CONDITION__FEATURE, false));
		feeder.finish();
	}
	...
	protected void sequence_Delta_access(ISerializationContext context, Delta_access semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDelta_accessAccess().getNameQUALIFIED_TYPE_IDENTIFIERParserRuleCall_1_0(), semanticObject.getName());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (deltaspec=[Delta_decl|TYPE_IDENTIFIER] after_condition=After_condition? from_condition=From_condition? when_condition=When_condition?)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=TYPE_IDENTIFIER (p+=Delta_param p+=Delta_param*)? delta_access+=Delta_access* module_modifier+=Module_modifier*)
	 */
	 ...
	 *     (
	 *         pure_exp=Pure_exp | 
	 *         (l='local'? c=QUALIFIED_TYPE_IDENTIFIER pure_exp_list=Pure_exp_list) | 
	 *         (a='await'? o=Pure_exp m=IDENTIFIER pure_exp_list=Pure_exp_list) | 
	 ...
	 *
	 * Constraint:
	 *     (feature_decl_group=Feature_decl_group? (feature_decl_attribute+=Feature_decl_attribute | feature_decl_constraint+=Feature_decl_constraint)*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (f=[Field_decl|IDENTIFIER] | m=[Methodsig|IDENTIFIER] | i=[Interface_decl|TYPE_IDENTIFIER])
	 */
	...
	protected void sequence_Interface_name(ISerializationContext context, Interface_name semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getInterface_nameAccess().getNameQUALIFIED_TYPE_IDENTIFIERParserRuleCall_0(), semanticObject.getName());
		feeder.finish();
	}
	...
	protected void sequence_MexpAtomic_expr(ISerializationContext context, Mexp semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getMexpAtomic_exprAccess().getValueINTLITERALTerminalRuleCall_1_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=QUALIFIED_TYPE_IDENTIFIER module_export+=Module_export* module_import+=Module_import* decl+=Decl* main_block+=Main_block?)
	 */
	 ...
	 * Constraint:
	 *     (
	 *         (star=MULT importedNamespace=QUALIFIED_TYPE_IDENTIFIER) | 
	 *         (name+=ANY_IDENTIFIER name+=ANY_IDENTIFIER* importedNamespace=QUALIFIED_TYPE_IDENTIFIER) | 
	 ...
	 *
	 * Constraint:
	 *     (((feature+=Feature feature+=Feature*)? product_reconfiguration+=Product_reconfiguration*) | product_expr=Product_expr)?
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=TYPE_IDENTIFIER delta_id+=Delta_id delta_id+=Delta_id* update=TYPE_IDENTIFIER)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=TYPE_IDENTIFIER feature+=Feature feature+=Feature* delta_clause+=Delta_clause*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=TYPE_IDENTIFIER trait_expr=Trait_expr)
	 */
	protected void sequence_Trait_decl(ISerializationContext context, Trait_decl semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getTrait_declAccess().getNameTYPE_IDENTIFIERTerminalRuleCall_1_0(), semanticObject.getName());
	...
	protected void sequence_Typesyn_decl(ISerializationContext context, Typesyn_decl semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getTypesyn_declAccess().getNameTYPE_IDENTIFIERTerminalRuleCall_1_0(), semanticObject.getName());
	 ...
	 *
	 * Constraint:
	 *     (name=TYPE_IDENTIFIER object_update+=Object_update*)
	 */
