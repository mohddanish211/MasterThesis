 ...
 *   <li>{@link org.xtext.abs.impl.PlusOrMinus_exprImpl#getOp <em>Op</em>}</li>
...
public class PlusOrMinus_exprImpl extends Pure_expImpl implements PlusOrMinus_expr
{
  ...
  public void setOp(String newOp)
  {
    ...
    op = newOp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AbsPackage.PLUS_OR_MINUS_EXPR__OP, oldOp, op));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AbsPackage.PLUS_OR_MINUS_EXPR__LEFT:
        return getLeft();
      case AbsPackage.PLUS_OR_MINUS_EXPR__OP:
        return getOp();
      case AbsPackage.PLUS_OR_MINUS_EXPR__RIGHT:
        return getRight();
    }
