 ...
 * <ul>
 *   <li>{@link org.xtext.abs.impl.When_conditionImpl#getApplication_condition <em>Application condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class When_conditionImpl extends MinimalEObjectImpl.Container implements When_condition
{
  /**
  ...
  {
    return AbsPackage.Literals.WHEN_CONDITION;
  }
  ...
  public NotificationChain basicSetApplication_condition(Application_condition newApplication_condition, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AbsPackage.WHEN_CONDITION__APPLICATION_CONDITION, oldApplication_condition, newApplication_condition);
  ...
  public void setApplication_condition(Application_condition newApplication_condition)
  {
    if (newApplication_condition != application_condition)
    {
      ...
      if (application_condition != null)
        msgs = ((InternalEObject)application_condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AbsPackage.WHEN_CONDITION__APPLICATION_CONDITION, null, msgs);
      if (newApplication_condition != null)
        msgs = ((InternalEObject)newApplication_condition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AbsPackage.WHEN_CONDITION__APPLICATION_CONDITION, null, msgs);
      msgs = basicSetApplication_condition(newApplication_condition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AbsPackage.WHEN_CONDITION__APPLICATION_CONDITION, newApplication_condition, newApplication_condition));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AbsPackage.WHEN_CONDITION__APPLICATION_CONDITION:
