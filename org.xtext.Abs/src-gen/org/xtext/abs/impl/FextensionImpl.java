...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fextension</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.xtext.abs.impl.FextensionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.abs.impl.FextensionImpl#getFeature_decl_group <em>Feature decl group</em>}</li>
 *   <li>{@link org.xtext.abs.impl.FextensionImpl#getFeature_decl_attribute <em>Feature decl attribute</em>}</li>
 *   <li>{@link org.xtext.abs.impl.FextensionImpl#getFeature_decl_constraint <em>Feature decl constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FextensionImpl extends MinimalEObjectImpl.Container implements Fextension
{
  /**
  ...
  {
    return AbsPackage.Literals.FEXTENSION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AbsPackage.FEXTENSION__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetFeature_decl_group(Feature_decl_group newFeature_decl_group, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AbsPackage.FEXTENSION__FEATURE_DECL_GROUP, oldFeature_decl_group, newFeature_decl_group);
  ...
  public void setFeature_decl_group(Feature_decl_group newFeature_decl_group)
  {
    if (newFeature_decl_group != feature_decl_group)
    {
      ...
      if (feature_decl_group != null)
        msgs = ((InternalEObject)feature_decl_group).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AbsPackage.FEXTENSION__FEATURE_DECL_GROUP, null, msgs);
      if (newFeature_decl_group != null)
        msgs = ((InternalEObject)newFeature_decl_group).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AbsPackage.FEXTENSION__FEATURE_DECL_GROUP, null, msgs);
      msgs = basicSetFeature_decl_group(newFeature_decl_group, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AbsPackage.FEXTENSION__FEATURE_DECL_GROUP, newFeature_decl_group, newFeature_decl_group));
  }
  ...
  public EList<Feature_decl_attribute> getFeature_decl_attribute()
  {
    ...
    {
      feature_decl_attribute = new EObjectContainmentEList<Feature_decl_attribute>(Feature_decl_attribute.class, this, AbsPackage.FEXTENSION__FEATURE_DECL_ATTRIBUTE);
    }
  ...
  public EList<Feature_decl_constraint> getFeature_decl_constraint()
  {
    ...
    {
      feature_decl_constraint = new EObjectContainmentEList<Feature_decl_constraint>(Feature_decl_constraint.class, this, AbsPackage.FEXTENSION__FEATURE_DECL_CONSTRAINT);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AbsPackage.FEXTENSION__FEATURE_DECL_GROUP:
        return basicSetFeature_decl_group(null, msgs);
      case AbsPackage.FEXTENSION__FEATURE_DECL_ATTRIBUTE:
        return ((InternalEList<?>)getFeature_decl_attribute()).basicRemove(otherEnd, msgs);
      case AbsPackage.FEXTENSION__FEATURE_DECL_CONSTRAINT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AbsPackage.FEXTENSION__NAME:
        return getName();
      case AbsPackage.FEXTENSION__FEATURE_DECL_GROUP:
