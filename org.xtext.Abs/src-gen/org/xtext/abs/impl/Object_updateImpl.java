...
public class Object_updateImpl extends MinimalEObjectImpl.Container implements Object_update
{
  ...
  public NotificationChain basicSetGuard(Guard newGuard, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AbsPackage.OBJECT_UPDATE__GUARD, oldGuard, newGuard);
  ...
  public void setGuard(Guard newGuard)
  {
    if (newGuard != guard)
    {
      ...
      if (guard != null)
        msgs = ((InternalEObject)guard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AbsPackage.OBJECT_UPDATE__GUARD, null, msgs);
      if (newGuard != null)
        msgs = ((InternalEObject)newGuard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AbsPackage.OBJECT_UPDATE__GUARD, null, msgs);
      msgs = basicSetGuard(newGuard, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AbsPackage.OBJECT_UPDATE__GUARD, newGuard, newGuard));
  }
