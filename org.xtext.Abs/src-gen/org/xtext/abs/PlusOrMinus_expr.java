 ...
 *   <li>{@link org.xtext.abs.PlusOrMinus_expr#getOp <em>Op</em>}</li>
...
public interface PlusOrMinus_expr extends Pure_exp
{
   ...
   * @see #setOp(String)
   * @see org.xtext.abs.AbsPackage#getPlusOrMinus_expr_Op()
   * @model
   * @generated
   */
  String getOp();
  ...
  /**
   * Sets the value of the '{@link org.xtext.abs.PlusOrMinus_expr#getOp <em>Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
