...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Fextension</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link org.xtext.abs.Fextension#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.abs.Fextension#getFeature_decl_group <em>Feature decl group</em>}</li>
 *   <li>{@link org.xtext.abs.Fextension#getFeature_decl_attribute <em>Feature decl attribute</em>}</li>
 *   <li>{@link org.xtext.abs.Fextension#getFeature_decl_constraint <em>Feature decl constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.abs.AbsPackage#getFextension()
 * @model
 * @generated
 */
public interface Fextension extends EObject
{
  /**
   ...
   * @see #setName(String)
   * @see org.xtext.abs.AbsPackage#getFextension_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.xtext.abs.Fextension#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.abs.AbsPackage#getFextension_Feature_decl_group()
  ...
  /**
   * Sets the value of the '{@link org.xtext.abs.Fextension#getFeature_decl_group <em>Feature decl group</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.abs.AbsPackage#getFextension_Feature_decl_attribute()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.xtext.abs.AbsPackage#getFextension_Feature_decl_constraint()
   * @model containment="true"
   * @generated
   */
