...
{
  /**
   * Returns the value of the '<em><b>Function name decl</b></em>' attribute list.
   * The list contents are of type {@link java.lang.String}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Function name decl</em>' attribute list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Function name decl</em>' attribute list.
   * @see org.xtext.abs.AbsPackage#getFunction_name_list_Function_name_decl()
   * @model unique="false"
   * @generated
   */
  EList<String> getFunction_name_decl();
