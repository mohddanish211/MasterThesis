...
public interface Product_reconfiguration extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Delta id</b></em>' attribute list.
   * The list contents are of type {@link java.lang.String}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Delta id</em>' attribute list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Delta id</em>' attribute list.
   * @see org.xtext.abs.AbsPackage#getProduct_reconfiguration_Delta_id()
   * @model unique="false"
   * @generated
   */
  EList<String> getDelta_id();
