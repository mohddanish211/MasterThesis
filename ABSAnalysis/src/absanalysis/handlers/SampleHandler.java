...
public class SampleHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			System.out.println("xxxxxxxxxxxx"+pat1h);
			String[] param= {"java","-cp" ,"absfrontend.jar","abs.backend.prolog.PrologBackend" ,"-d" ,"/tmp/costabs/absPL" ,"/home/danish/MayPar/MayPar/examples/PeerToPeer.abs"};
			//String[] param= {"java -cp /home/danish/MayPar/MayPar/lib/absfrontend.jar abs.backend.prolog.PrologBackend -d /tmp/costabs/absPL /home/danish/MayPar/MayPar/examples/PeerToPeer.abs && MayPar main  -v 3 -mode complete -l"};
			...
			System.out.println("Output of Buffer Reader is stdInput "+stdInput);


			BufferedReader stdError = new BufferedReader(new 
					InputStreamReader(process.getErrorStream()));
			System.out.println("Output of Buffer Reader is stdError "+stdError);

			// read the output from the command
			System.out.println("Here is the standard output of the command:\n");
			String s = null;
			while ((s = stdInput.readLine()) != null) {
				System.out.println("--------xxInside stdinputx-------");
			...
			System.out.println("--------xxInside 	EXC	EP	tion-------");
